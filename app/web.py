...
def get_db_time():
        conn = psycopg2.connect("host= {0} dbname={1} user={2} password={3}".format(get_db_config('db_host'), get_db_config('db_name'), get_db_config('db_user'), get_db_config('db_password')))
